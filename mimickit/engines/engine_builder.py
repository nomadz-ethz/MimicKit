...
def build_engine(config, num_envs, device, visualize, enable_cameras=False):
    ...
    if (eng_name == "isaac_gym"):
        ...
        engine = isaac_lab_engine.IsaacLabEngine(config, num_envs, device, visualize, enable_cameras=enable_cameras)
